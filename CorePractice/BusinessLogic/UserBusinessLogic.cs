...
namespace CorePractice.BusinessLogic
{
    public class UserBusinessLogic
    {
        ...
        public User Update(int userId, string username, string password, string firstname, string lastname, DateTime dateOfBirth, string email, string phone, string mobile, List<Group> groups)
        {
